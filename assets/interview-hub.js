  ...
  var GROUPS = [
    ...
    },
    {
      ...
      pages: [
        ...
        { path: "interview-prep/09-sql-for-genai.html", href: "../interview-prep/09-sql-for-genai.html", local: true, title: "SQL & Data Systems for GenAI Roles", desc: "2026 topic list, joins, windows, LAG, recursive CTEs, plans, upserts, pgvector, safe text-to-SQL and practice drills.", kw: "sql joins window functions row_number rank lag recursive cte order of execution indexing explain query plan transactions upsert merge materialized view postgres jsonb pgvector text to sql rls multi tenant practice queries 2026" }
      ]
    },
    {
      id: "core",
